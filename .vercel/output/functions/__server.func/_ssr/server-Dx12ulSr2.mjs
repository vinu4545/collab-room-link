...
import { i as __exportAll, n as createCsrfMiddleware } from "./server-Dx12ulSr.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-6v7S_mqy.mjs");
...
var manifest = {
	"2cbaca56aaba4ac68569dffeaacb4d28a933109c07065b85a06c40b7c9ad442c": {
		...
		importer: () => import("./terminal.functions-juxh440D.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BEG1uDmb.mjs").then((n) => n.t),
